...
$(function () {
     ...
     */
        //菜单效果
    $('input.image-uploader').live('mouseenter',function () {
    ...
    $('input[name="geo[data][]"]').live('click', function (e) {
        var ids = [];
    ...
    //table area
    $('table .area_filter_tr').live('click', function (event) {
        //todo 阻止多次ajax请求
     ...
     */
    $('.ajaxBtn_analyse').live('click', function (event) {
        var current = $(this);
    ...
    //geo force
    $('.JGeoForce').live('click', function (event) {
