!function (c) {
    ...
    var e = function (h, g) {
        ...
        this.component = this.element.is(".date") ? this.element.find(".add-on .glyphicon glyphicon-th, .add-on .glyphicon glyphicon-time, .add-on .glyphicon glyphicon-calendar").parent() : false;
        this.componentReset = this.element.is(".date") ? this.element.find(".add-on .glyphicon glyphicon-remove").parent() : false;
        ...
        if (this.isRTL) {
            ...
            this.picker.find(".prev i, .next i").toggleClass("glyphicon glyphicon-arrow-left glyphicon glyphicon-arrow-right")
        }
