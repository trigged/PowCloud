<?php echo $header; ?>
    <div class="monitor">
        <?php foreach ($apiData as $tableName => $apiInfo): ?>
            <?php $time = 0; $count = 0; $methodAll = array('rgb(74,228,43) ' => 'index', 'rgb(28,171,251)' => 'show', 'rgb(245,191,0)' => 'edit','rgb(245,42,42)' => 'delete'); ?>
            <div class="<?php echo $tableName; ?> monitor-row row ">
                <div class="span2 default box" style="margin:0 auto"><div class="table-name"><span><?php echo ucfirst($tableName); ?></span></div></div>
                <?php foreach ($methodAll as $color => $subMethod) :?>
                    <div class="span2 <?php echo $subMethod?> box" style="margin:0 auto; background: <?php echo $color?>; ">
                ...
                <?php endforeach; ?>
                <div class="span2 Total box default" style="margin:0 auto;">
