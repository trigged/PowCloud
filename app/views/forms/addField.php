        ...
        <form id="forms" class="form-horizontal child_form"  method="post">
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="field" class="input-medium" value="" type="text" placeholder="" id="field">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="label" class="input-medium" value="" type="text" placeholder="" id="label">
                    </div>
                </div>
                <div class="control-group">
                    <label for="dataType" class="control-label">数据类型*:</label>
                    <div class="controls">
                        <?php echo Form::select('dataType',Config::get('params.dataType'),'',array('class'=>'input-small')); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label for="type" class="control-label">类型*:</label>
                    <div class="controls">
                        <?php echo Form::select('type',Config::get('params.formField'),'',array('class'=>'input-small JFieldType')); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label for="default_value" class="control-label">默认值:</label>
                    <div class="controls JDefaultValue">
                        <input  name="default_value" class="input-xxlarge" type="text" value="" placeholder="默认值" id="default_value">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php  echo Form::textarea('rules','',array('class'=>'input-xxlarge')) ?>
                    </div>
                </div>
                <div class="control-group">
                    <label for="rank" class="control-label">排序:</label>
                    <div class="controls">
                        <input  name="rank" class="input-mini" type="text" value="" placeholder="默认值" id="rank">
                    </div>
                </div>
                <div class="control-group">
                    <label for="rank" class="control-label">列表是否可见:</label>
                    <div class="controls">
                        <?php echo Form::select('isVisible', array('1'=>'可见', '0'=>'不可见'),'', array('class'=>'input-small')); ?>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo Form::select('isEditable', array(1=>'可输入', 0=>'不可输入'),(int)1, array('class'=>'input-small')); ?>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo Form::select('visibleByGroup',array('0'=>'无限制')+Group::getGroups() ,(int)0, array('class'=>'input-small')); ?>
                    </div>
                </div>
