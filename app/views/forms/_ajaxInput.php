...
<div class="JNormalInput" style="display: none">
    <input type="text" id="default_value" placeholder="默认值" value="" class="input-xxlarge" name="default_value">
</div>
<?php
    $tableIndex=2;
...
<script>
    $(function(){
        ...
        $('.JAjaxInput').live('click',function(){
            ...
            var trTpl = '<tr><td><input type="text" value="" name="default_value[data][{tableIndex}][data]">&nbsp;&nbsp;<a style="cursor:pointer;" data-mapIndex="2" data-tableIndex="{data-tableIndex}" data-type="td" class="JAjaxInput" href="javascript:;"><i class="icon-plus"></i></a>&nbsp;&nbsp;<a href="javascript:;"  class="JAjaxInput" data-type="delete-tr" style="cursor:pointer;"><i class="icon-remove"></i></a></td><td><div style="margin-bottom: 5px;"><input type="text" value="" class="input-small" name="default_value[data][{tableIndex}][map][{mapIndex}][localField]">&nbsp;&nbsp;&nbsp;<input type="text" value="" class="input-small" name="default_value[data][{tableIndex}][map][{mapIndex}][remoteField]">&nbsp;&nbsp;<a href="javascript:;"  class="JAjaxInput" data-type="delete-td" style="cursor:pointer;"><i class="icon-remove"></i></a></div></td></tr>';
            var tdTpl = '<div style="margin-bottom: 5px;"><input type="text" value="" class="input-small" name="default_value[data][{tableIndex}][map][{mapIndex}][localField]">&nbsp;&nbsp;&nbsp;<input type="text" value="" class="input-small" name="default_value[data][{tableIndex}][map][{mapIndex}][remoteField]">&nbsp;&nbsp;<a href="javascript:;"  class="JAjaxInput" data-type="delete-td" style="cursor:pointer;"><i class="icon-remove"></i></a></div>';
