...
<?php if($forms): ?>
    <div class="formsList">
        ...
        <table id="forms_table" class="table table-hover sortable">
            ...
            <tbody <tbody data-table="forms_table"
            ...
            <?php foreach($forms as $index => $form): ?>
                <tr data-rank="<?php echo $index ?>" data-id="<?php echo $form->id ?>">
                    ...
                    <td class="operation">
                        <a title="编辑" href="<?php echo URL::action('FormsController@edit',array('form'=>$form->id)) ;?>"><i class="icon-edit"></i></a>
                        <a class="JS_hostOp" data-url="<?php echo URL::action('FormsController@destroy',array('form'=>$form->id)) ?>" href="#" data-status="<?php echo $form->deleted_at?'restore':'delete'; ?>" data-target="<?php echo $form->id;?>" href="javascript:void(0)">
