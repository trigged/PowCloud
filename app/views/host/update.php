        ...
        <form id="host_form" class="form-horizontal" method="post">
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="name" class="input-medium" value="<?php echo $host->name; ?>" type="text" placeholder="主机名称" id="name">
                    </div>
                </div>
                <div class="control-group">
                    <label for="host" class="control-label">主机地址*:</label>
                    <div class="controls">
                        <span class="input-xlarge uneditable-input"><?php echo $host->host; ?></span>
                    </div>
                </div>
                <div class="control-group">
                    <label for="comment" class="control-label">备注:</label>
                    <div class="controls">
                        <textarea  rows="3" name="comment" value="<?php echo $host->comment; ?>" id="comment" style="width: 439px;"></textarea>
                    </div>
                </div>
                <div class="control-group">
                    <label for="expire" class="control-label">页面缓存时间:</label>
                    <div class="controls">
                        <input class="expire" name="expire" type="text" value="<?php echo $host->expire; ?>" placeholder="有效期" id="expire">
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio inline">
                            <input class="" type="radio" <?php echo (int)$host->cdn===1?'checked=""':'';  ?> name="cdn" value="1"  id="" /> 开启
                        </label>
                        <label class="radio inline">
                            <input class="" type="radio" name="cdn" <?php echo (int)$host->cdn===0?'checked=""':'';  ?>" value="0"  id="" /> 关闭
                        </label>
                    </div>
                </div>
