    ...
    <?php foreach($hosts as $host): ?>
        <tr>
            ...
            <td>
                <?php echo $host->host; ?>&nbsp;&nbsp;
                <?php if($host->comment):?>
                <a class="comment" rel="popover" href="javascript:void(0)" data-original-title="备注" data-content="<?php echo $host->comment ?>">
            ...
            <td class="operation">
                <a href="<?php echo URL::action('HostController@edit',array('host'=>$host->id)) ;?>"><i class="icon-edit"></i></a>
                <a data-tip ="<?php echo $host->name; ?>" class="JS_hostOp" data-url="<?php echo URL::action('HostController@destroy',array('host'=>$host->id)) ?>" href="#" data-status="<?php echo $host->deleted_at?'restore':'delete'; ?>" data-target="<?php echo $host->id;?>" href="javascript:void(0)">
