<?php echo $header; ?>
    <form method="post">
        <fieldset>
            ...
            <div class="controls">
                <input type="text" name="redis_command" placeholder="Type redis command…" value="<?php echo $data['redis_command']; ?>" class="input-xxlarge">
            </div>

            <span class="help-block">只支持一般查询如:Hget,hgetall,zscore,zcount.......</span>
            <?php if(!empty($data['error']['errorMessage'])): ?><span class="help-block"><?php echo $data['error']['errorMessage']  ?></span><?php endif; ?>
