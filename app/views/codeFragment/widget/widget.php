...
<?php if($widgets): ?>
    <div class="widgetsList">
        ...
        <div class="" style="">
            <a href="<?php echo URL::action('CodeFragmentController@createWidget') ?>" class="btn btn-primary" type="button">添加数据</a>
        </div>
        <table class="table table-striped">
            ...
            <?php foreach($widgets as $widget): ?>
                ...
                <span class="label label-<?php echo $widget->deleted_at?'disable':'info'; ?>">
                    ...
                    <td class="operation">
                        <a href="<?php echo URL::action('CodeFragmentController@editWidget',array('widget'=>$widget->id)) ;?>"><i class="icon-edit"></i></a>
                        <a title="查看历史版本" href="<?php echo URL::action('CodeFragmentController@widgetDetail',array('widget'=>$widget->id));?>"><i class="icon-file"></i></a>
<!--                        <a class="JS_widgetOp" data-url="--><?php //echo URL::action('CodeFragmentController@disableWidget',array('widget'=>$widget->id)) ?><!--" data-status="--><?php //echo $widget->deleted_at?'restore':'delete'; ?><!--" data-target="--><?php //echo $widget->id;?><!--" href="javascript:void(0)">-->
