            ...
            <?php foreach($groupModels as $groupModel): ?>
                <tr>
                    ...
                    <td class="operation limit" >
                        <a href="<?php echo URL::action('LimitController@edit',array('limit'=>$groupModel->id)) ;?>"><i class="icon-edit"></i></a>
                        <a class="JS_groupModelOp" data-url="<?php echo URL::action('LimitController@destroy',array('limit'=>$groupModel->id)) ?>" href="#" data-target="<?php echo $groupModel->id;?>" href="javascript:void(0)"><i title="删除" class="icon-remove"></i>
                        </a>
                    </td>
                </tr>
            <?php endforeach;?>
