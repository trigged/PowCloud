    ...
    <div class="">
        ...
        <form data-status="0" id="user_form" class="form-horizontal"  onsubmit="return check_form(this)">
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="name" class="input-medium" value="<?php echo $user->name; ?>" type="text" placeholder="用户名" id="name">
                </div>
            </div>
            <div class="control-group">
                <label for="groupName" class="control-label">选择用户组:</label>
                <div class="controls">
                    <?php echo Form::select('group_id',  array('' => '') + Group::lists('groupName', 'id'), $user->group_id)?>
                </div>
            </div>
            <div class="control-group">
                <label for="email" class="control-label">邮箱*:</label>
                <div class="controls">
                    <input name="email" class="input-medium" value="<?php echo $user->mail; ?>" type="text" placeholder="用户邮箱" id="email">
                </div>
            </div>
            <div class="control-group">
                <label for="department" class="control-label">部门:</label>
                <div class="controls">
                    <input name="department" class="input-medium" value="<?php echo $user->department; ?>" type="text" placeholder="部门" id="department">
                </div>
            </div>
