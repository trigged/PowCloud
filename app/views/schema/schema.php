    ...
    <div class="schema">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td>
                    <a  class="JS_tableOp" href="javascript:void(0) " data-tip="<?php echo $schemaItemName; ?>" data-url="<?php echo URL::action('SchemaBuilderController@destroyField',array('table'=>$table->id,'field'=>$schemaItemName)) ?>"  data-target="<?php echo $table->id;?>"><i title="删除" class="icon-remove"></i></a>
                </td>
            </tr>
            <?php endforeach;?>
            </tbody>
